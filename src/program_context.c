  ...
  static struct option long_options[] =
    {
      ...
      {"entries", required_argument, NULL, 0},
      {"files", required_argument, NULL, 0},
      ...
      {"no-binary", no_argument, NULL, 'I'},
      {"no-filename", no_argument, NULL, 'h'},
      {"no-entryname", no_argument, NULL, 'e'},
      {"quiet", no_argument, NULL, 'q'},
      {"recurse", no_argument, NULL, 'r'},
      {"text", no_argument, NULL, 0},
      {"version", no_argument, NULL, 'v'},
      {"word-regexp", no_argument, NULL, 'o'},
   ...
   while (ret)
     {
     int option_index = 0;
     opt = getopt_long (argc, argv, "?fhiIvl:w:ram:oqne",
     ...
     switch (opt)
       ...
       case 0:
         ...
         else if (strcmp (long_options[option_index].name, "first") == 0)
           program_context_put_boolean (self, "first", TRUE);
         else if (strcmp (long_options[option_index].name, "no-entryname") == 0)
           program_context_put_boolean (self, "no-entryname", TRUE);
         else if (strcmp (long_options[option_index].name, "line-number") == 0)
           program_context_put_boolean (self, "line-number", TRUE);
         else if (strcmp (long_options[option_index].name, "word-regexp") == 0)
           program_context_put_boolean (self, "word-regexp", TRUE);
         else if (strcmp (long_options[option_index].name, "version") == 0)
           program_context_put_boolean (self, "show-version", TRUE);
         else if (strcmp (long_options[option_index].name, "ignore-case") == 0)
           program_context_put_boolean (self, "ignore-case", TRUE);
         else if (strcmp (long_options[option_index].name, "quiet") == 0)
           program_context_put_boolean (self, "quiet", TRUE);
         else if (strcmp (long_options[option_index].name, "no-filename") == 0)
           program_context_put_boolean (self, "no-filename", TRUE);
         else if (strcmp (long_options[option_index].name, "all") == 0)
           program_context_put_boolean (self, "all", TRUE);
         else if (strcmp (long_options[option_index].name, "no-binary") == 0)
           program_context_put_boolean (self, "no-binary", TRUE);
         else if (strcmp (long_options[option_index].name, "recurse") == 0)
           program_context_put_boolean (self, "recurse", TRUE);
         else if (strcmp (long_options[option_index].name, "text") == 0)
           program_context_put_boolean (self, "text", TRUE);
         ...
         else if (strcmp (long_options[option_index].name, "files") == 0)
           program_context_put (self, "files", optarg); 
         else if (strcmp (long_options[option_index].name, "max-size") == 0)
           program_context_put (self, "max-size", optarg); 
         else if (strcmp (long_options[option_index].name, "entries") == 0)
           program_context_put (self, "entries", optarg); 
         else
           exit (-1);
         break;
       case '?': 
       ...
       case 'e': 
         program_context_put_boolean (self, "no-entryname", TRUE); break;
       case 'f': 
         program_context_put_boolean (self, "first", TRUE); break;
       case 'q': 
         program_context_put_boolean (self, "quiet", TRUE); break;
       case 'v': 
         program_context_put_boolean (self, "show-version", TRUE); break;
       case 'h': 
         program_context_put_boolean (self, "no-filename", TRUE); break;
       case 'n': 
         program_context_put_boolean (self, "line-number", TRUE); break;
       case 'r': 
         program_context_put_boolean (self, "recurse", TRUE); break;
       case 'i': 
         program_context_put_boolean (self, "ignore-case", TRUE); break;
       case 'I': 
         program_context_put_boolean (self, "no-binary", TRUE); break;
       case 'o': 
         program_context_put_boolean (self, "word-regexp", TRUE); break;
       case 'a': 
         program_context_put_boolean (self, "all", TRUE); break;
       case 'l': program_context_put_integer (self, "log-level", 
           atoi (optarg)); break;
       case 'm': program_context_put (self, "max-size", optarg); break;
...
==========================================================================*/
int program_context_get_int64 (const ProgramContext *self, 
